...
/* harmony export */   initializeChatOverride: () => (/* binding */ initializeChatOverride),
...
/* harmony import */ var mutation_summary__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! mutation-summary */ "./node_modules/mutation-summary/dist/umd/mutation-summary.js");
/* harmony import */ var _navigation_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./navigation.js */ "./navigation.js");
/* harmony import */ var _lib_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./lib.js */ "./lib.js");
...
const processChatMessage = (chatMessageBody) => {
  if (!chatMessageBody || !(0,_emotes_js__WEBPACK_IMPORTED_MODULE_0__.containsEmote)(chatMessageBody)) return null;
...
async function onChatMutation(summaries) {
  ...
  if (chatContainerAdded || !currentMessageContainer) {
    ...
    const currentUsername = (0,_navigation_js__WEBPACK_IMPORTED_MODULE_2__.matchChannelName)(window.location.href);

    if (currentUsername) {
      const data = await (0,_lib_js__WEBPACK_IMPORTED_MODULE_3__.getTwitchUserId)(currentUsername);
      await (0,_emotes_js__WEBPACK_IMPORTED_MODULE_0__.loadEmotes)({ id: data.id, username: data.username });
    }
  }
}
...
function initializeChatOverride() {
  ...
  new mutation_summary__WEBPACK_IMPORTED_MODULE_1__.MutationSummary({
...
/* harmony import */ var _emotes_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./emotes.js */ "./emotes.js");
/* harmony import */ var _navigation_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./navigation.js */ "./navigation.js");
/* harmony import */ var _dom2_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./dom2.js */ "./dom2.js");
...
(0,_dom2_js__WEBPACK_IMPORTED_MODULE_3__.initializeChatOverride)();

async function main() {
  await (0,_dom2_js__WEBPACK_IMPORTED_MODULE_3__.addModifierStyles)();
  await (0,_emotes_js__WEBPACK_IMPORTED_MODULE_1__.initializeEmotes)();
  const currentUsername = (0,_navigation_js__WEBPACK_IMPORTED_MODULE_2__.matchChannelName)(window.location.href);

  if (currentUsername) {
    (0,_navigation_js__WEBPACK_IMPORTED_MODULE_2__.setUsername)(currentUsername);
